 ...
 */
final class Version20240903080534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, status_id INT NOT NULL, campus_id INT NOT NULL, place_id INT NOT NULL, name VARCHAR(255) NOT NULL, event_start DATETIME NOT NULL, participation_deadline DATE NOT NULL, participant_limit INT NOT NULL, duration INT DEFAULT NULL, description VARCHAR(1000) DEFAULT NULL, INDEX IDX_3BAE0AA76BF700BD (status_id), INDEX IDX_3BAE0AA7AF5D55E1 (campus_id), INDEX IDX_3BAE0AA7DA6A219 (place_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
